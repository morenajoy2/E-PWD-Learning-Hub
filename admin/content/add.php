...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `learning-contents`
    (`learning_content_title`, `learning_content_description`, `learning_content_upload_date`, `learning_content_posted_by`, `learning_content_class_section`, `learning_content_youtube_embed`) 
    VALUES
    ('$title', '$description', '$post_date', '$user_id', '$audience', '$youtube_embed')";
