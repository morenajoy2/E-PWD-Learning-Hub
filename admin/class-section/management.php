...
$sql = "SELECT cs.*, 
               CONCAT(u.user_last_name, ', ', u.user_first_name, ' ', u.user_middle_name) AS adviser_name 
...
<body>
    ...
    <main>
        ...
        <div class="btn">
            ...
            <a href="admin/class-section/add">
        ...
        <section class="class-section-management">
            ...
            <table id="class-section">
                ...
                foreach ($class_sections as $class_section) {
                    ...
                    echo "<td><a href='admin/class-section/edit/{$class_section['class-section_id']}'><button id='edit-btn'>Edit</button></a></td>";
    ...
    <script>
        function confirmDelete(sectionId) {
            ...
            if (confirmation) {
                window.location.href = "admin/class-section/delete/" + sectionId;
            }
        }
    </script>
