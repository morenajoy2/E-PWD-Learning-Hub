    ...
    <main>
        ...
        <section class="quicklinks">
            <table id="quicklinks">
                ...
                $sql = "SELECT cs.`class-section_id` AS class_section_id, cs.section_name, cs.school_year, cs.term_no, 
                               CONCAT(TRIM(COALESCE(u.user_first_name, '')), ' ', TRIM(COALESCE(u.user_middle_name, '')), ' ', TRIM(COALESCE(u.user_last_name, ''))) AS adviser_name
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="./admin/class-section/view/<?php echo $section_id; ?>">
