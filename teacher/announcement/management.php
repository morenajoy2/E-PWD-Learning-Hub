...
<body>
    ...
    <main>
        ...
        <div class="btn">
            ...
            <a href="./teacher/announcement/add">
        ...
        <section class="announcement-management">
            ...
            <table id="announcements">
                ...
                $teacher_id = (int) $_SESSION['user_id'];
                    $sql = "SELECT * FROM announcements WHERE announcement_posted_by = $teacher_id";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row_table = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><a href="teacher/announcement/edit/<?php echo $id; ?>"><button id="edit-btn">Edit</button></a>
                                </td>
    ...
    <script>
        function confirmDelete(announcementId) {
            ...
            if (confirmation) {
                window.location.href = "teacher/announcement/delete/" + announcementId;
            }
        }
    </script>
